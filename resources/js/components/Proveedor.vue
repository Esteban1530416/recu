<template>
            ...
            <div class="container-fluid">
                <!-- Ejemplo de tabla Listado  esta tabla muestra listado de los proveedores -->
                <div class="card">
                        ...
                        <div class="modal-body">
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" v-model="alias" class="form-control" placeholder="Nombre de la persona">                                        
                                    </div>
                                </div>
                                 <div class="form-group row">
