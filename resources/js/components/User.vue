<template>
            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    ...
                    <!--en esta parte se muestra la vista donde se puede buscar mediante el nombre del usuario-->
                    <div class="card-body">
                        ...
                        <!--se enlista la tabala con los campos especificos de usuarios-->
                        <table class="table table-bordered table-striped table-sm">
                            ...
                            <!--Enlista todos los los usuarios que se mandaron a llamar -->
                            <tbody>
                        ...
                        <!--en esta parte se hace la paginacion para que no muestre el enlistado -->
                        <nav>
                            <ul class="pagination">
            ...
            <!--Inicio del modal agregar/actualizar  esto es lo que se abre cuando se da click en el boton agregar o modificar-->
